/*
  ...
  - You are about to drop the `AuthorRelation` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `HistoryType` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `Phrase` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE `AuthorRelation` DROP FOREIGN KEY `author_id_foreign`;

-- DropForeignKey
ALTER TABLE `AuthorRelation` DROP FOREIGN KEY `author_relationed_id_foreign`;

-- DropForeignKey
ALTER TABLE `AuthorRelation` DROP FOREIGN KEY `history_type_id_foreign`;
...
-- DropTable
DROP TABLE `AuthorRelation`;

-- DropTable
DROP TABLE `HistoryType`;
